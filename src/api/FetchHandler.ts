...
import Model from "@/api/struct/Model";
...
export default class FetchHandler {
     ...
     */
    static fetch<T extends Model | any>(options: FetchOptions): Promise<T> {
     ...
     */
    static fetchQuery<T extends Model | any>(
        fetchData: Promise<T>,
        errorOptions: QueryErrorOptions
    ): Query<T> {
